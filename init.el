...
(custom-set-variables
 ...
 '(gptel-directives
   '((default . "You are a large language model living in Emacs and a helpful assistant. Respond concisely and format maths as latex.")
     (programming . "You are a large language model and a careful programmer. Provide code and only code as output without any additional text, prompt or note.")
     (writing . "You are a large language model and a writing assistant. Respond concisely.")
     (chat . "You are a large language model and a conversation partner. Respond concisely and for maths as latex.")))
 ...
 '(package-selected-packages
   '(aidermacs lsp-javacomp command-log-mode lsp-java rg modus-themes cargo-mode ox-rss magit smart-shift jtsx switch-window ef-themes gptel dracula-theme vterm indent-tools quelpa quelpa-use-package ox-hugo flycheck-inline phoenix-dark-pink-theme lsp-ui anti-zenburn-theme hc-zenburn-theme zenburn-theme eglot vagrant-tramp yasnippet ## dash add-node-modules-path prettier poly-ansible jinja2-mode polymode yaml-mode ansible company-lsp rust-mode exec-path-from-shell tide buttercup flycheck-rust))
